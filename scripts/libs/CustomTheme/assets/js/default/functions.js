...
function changeTheme($theme, $style, $themeStylesheet, $init) {
    ...
    $baseUrl ='https://portaladmin.ispatialtec.com/portaladminapp'
    ...
    if ($theme === 'light') {
        ...
        $themeStylesheet.href = $baseUrl + '../scripts/libs/CustomTheme/assets/css/default/theme-' + $theme + stylePath + rtlString + '.min.css';
    } else if ($theme === 'dark') {
        $logo.attr('src', $mediaUrl + 'https://via.placeholder.com/334x119');
        $body.removeClass('theme-semidark').addClass('theme-dark');
        $themeStylesheet.href = $baseUrl + '../scripts/libs/CustomTheme/assets/css/default/theme-' + $theme + rtlString + '.min.css';
